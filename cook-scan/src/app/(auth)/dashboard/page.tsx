...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <Header title="CookScan ダッシュボード" rightAction={<LogoutButton />} />
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                ...
                <div className="mt-auto flex items-center text-sm font-medium text-green-600 transition-colors group-hover:text-emerald-600">
                  レシピを見る
                  <svg
                    className="ml-1 h-4 w-4 transition-transform group-hover:translate-x-1"
                    fill="none"
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                ...
                <div className="mt-auto flex items-center text-sm font-medium text-amber-600 transition-colors group-hover:text-orange-600">
                  タグを管理
                  <svg
                    className="ml-1 h-4 w-4 transition-transform group-hover:translate-x-1"
                    fill="none"

...
export function TagEmptyState() {
  return (
    <div className="overflow-hidden rounded-xl bg-white p-12 text-center shadow-lg">
      ...
      <h3 className="mt-6 text-lg font-semibold text-foreground">タグがまだありません</h3>
      <p className="mt-2 text-sm text-muted-foreground">
        上のフォームからタグとカテゴリを作成して、レシピを整理しましょう
      </p>
      <div className="mt-6 flex justify-center gap-2">
        <div className="flex items-center gap-2 rounded-lg bg-accent-steps-light px-4 py-2 text-sm text-accent-steps">

...
export function TagItem({ tag, usageCount, isUserOwned }: TagItemProps) {
  ...
  return (
    <div className="group relative inline-flex items-center gap-2 rounded-lg bg-gradient-to-br from-indigo-50 to-purple-50 px-4 py-2.5 shadow-sm ring-1 ring-indigo-200/50 transition-all hover:shadow-md hover:ring-indigo-300">
